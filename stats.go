...
const (
	...
	AchNoviceOricCelmist   achievement = "Novice Oric Celmist"
	AchInitiateOricCelmist achievement = "Initiate Oric Celmist"
	AchMasterOricCelmist   achievement = "Master Oric Celmist"
